...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayoutWidget.setGeometry(QRect(10, 10, 521, 706))
        ...
        self.btn_save_ch.setGeometry(QRect(10, 730, 141, 41))
        self.lbl_link = QLabel(self.centralwidget)
        self.lbl_link.setObjectName(u"lbl_link")
        self.lbl_link.setGeometry(QRect(280, 750, 241, 20))
        ...
        self.btn_del_ch.setGeometry(QRect(180, 730, 141, 41))
